...
const CropRecommendation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Save form data in Firebase (optional)
  try {
    ...
    console.log("Saved to Firebase:", res.status);
  } catch (error) {
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full max-w-4xl bg-[#cdf1c7] shadow-lg rounded-xl px-6 py-6"
      >
      {prediction && (
        <div className="mb-4 text-center bg-green-200 text-green-900 font-semibold py-2 rounded">
